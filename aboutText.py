about_text = "Esse aplicativo foi desenvolvido com o objetivo " \
             "de facilitar a organização de lembretes tornando mais " \
             "acessível para pessoas cegas e com baixa visão. Para isso, " \
             "esse aplicativo pode ser controlado por voz ou por meio de " \
             "botões coloridos e chamativos que possuem sua identificação " \
